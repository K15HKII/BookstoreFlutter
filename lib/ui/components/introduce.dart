...
class Introduce2 extends StatefulWidget {
  const Introduce2({Key? key}) : super(key: key);

  @override
  State<Introduce2> createState() => _Introduce2State();
}

class _Introduce2State extends State<Introduce2> {
  @override
                        ...
                        children: [
                          Padding(
                              ...
                              child: Align(
                                  ...
                                  child: Text(
                                    "giới thiệu ứng dụng aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa",
                                    style: TextStyle(
