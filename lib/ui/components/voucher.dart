...
class VoucherPanel extends StatefulWidget {
  const VoucherPanel({Key? key}) : super(key: key);

  @override
  State<VoucherPanel> createState() => _VoucherPanelState();
}

class _VoucherPanelState extends State<VoucherPanel> {
  @override
